...
import com.wizsuite.myhbrecordernew.recorders.HBRecorder;
import com.wizsuite.myhbrecordernew.recorders.HBRecorderCodecInfo;
import com.wizsuite.myhbrecordernew.recorders.HBRecorderListener;
...
public class MainActivity extends AppCompatActivity implements HBRecorderListener {
    ...
    private void setOnClickListeners() {
        startbtn.setOnClickListener(v -> {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                ...
                if (checkSelfPermissions(MainActivity.this, PERMISSIONS)) {
                    hasPermissions = true;
                } else {
    ...
    private void setOutputPath() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
            ...
            Log.d("VIDEO_PATH","Video Absolute Path: "+mUri+"/"+filename);
            hbRecorder.setFileName(filename);
            hbRecorder.setOutputUri(mUri);
        } else {
            createFolder();
            Log.d("VIDEO_PATH","Video Absolute Path: "+Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_MOVIES) + "/HBRecorder/"+filename);
